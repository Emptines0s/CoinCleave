...
Revision ID: f9c044630557
Revises: cdd1b2dcebd9
Create Date: 2022-10-31 03:34:02.549795
...
revision = 'f9c044630557'
down_revision = 'cdd1b2dcebd9'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('bot', sa.Column('state', sa.String(length=15), nullable=True))
    op.drop_column('bot', 'enabled')
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('bot', sa.Column('enabled', sa.BOOLEAN(), autoincrement=False, nullable=True))
    op.drop_column('bot', 'state')
