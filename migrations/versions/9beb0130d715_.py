...
Revision ID: 9beb0130d715
Revises: d909842ed880
Create Date: 2022-11-21 05:30:38.648241
...
revision = '9beb0130d715'
down_revision = 'd909842ed880'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('trade', sa.Column('order_id', sa.Integer(), nullable=True))
    op.add_column('trade', sa.Column('datetime', sa.BigInteger(), nullable=True))
